...
const ImageUploadSection = ({ index, previewUrl, setValue, error }: ImageUploadSectionProps) => {
    ...
    const handleRemoveImage = (e: React.MouseEvent) => {
        e.preventDefault();
        setValue(`dishes.${index}.image`, null, {
            shouldDirty: true,
            shouldValidate: true
        });
    };
                    ...
                    <div className="relative h-full w-full group">
                        ...
                        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center justify-center z-10">
                            <button
                                ...
                                className="p-3 bg-red-600 hover:bg-red-700 text-white rounded-full shadow-lg transition-transform transform scale-90 group-hover:scale-100 duration-200"
                                title="Remove Image"
                            >
