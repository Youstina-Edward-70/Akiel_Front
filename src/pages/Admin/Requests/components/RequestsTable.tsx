                        ...
                        {requests.map((req) => (
                            <tr key={req._id} className="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td className="px-6 py-5 text-sm text-center">
                                    <span className={`inline-flex px-3 py-1 rounded-full text-xs font-bold ${req.rejectionCount >= maxLimit ? 'bg-red-50 text-red-500' : req.rejectionCount > 0 ? 'bg-orange-50 text-orange-500' : 'bg-gray-50 text-gray-400'}`}>
                                ...
                                <td className="px-8 py-5">
                                    <div className="flex justify-end gap-3">
                                        <button
                                            ...
                                            disabled={isPending}
                                            className="p-2 text-green-500 hover:bg-green-50 rounded-xl transition-all active:scale-90 disabled:opacity-40 disabled:pointer-events-none"
                                        ...
                                        <button
                                            ...
                                            disabled={isPending}
                                            className="p-2 text-red-400 hover:bg-red-50 rounded-xl transition-all active:scale-90 disabled:opacity-40 disabled:pointer-events-none"
