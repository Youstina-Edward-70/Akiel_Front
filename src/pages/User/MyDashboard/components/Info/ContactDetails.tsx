import { IoCallOutline, IoMailOutline, IoLogoWhatsapp, IoLogoFacebook } from "react-icons/io5";
...
export const ContactDetails = ({ phoneNumber, email, whatsappNumber, facebookLink }: ContactDetailsProps) => {
    return (
        <section className="space-y-6">
            ...
            <div className="grid gap-4">
                ...
                <div className="flex items-center gap-4 text-text-secondary">
                    <div className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center">
                        <IoMailOutline className="text-xl text-secondary" />
                    </div>
                    <span className="font-bold">{email || 'Not Available'}</span>
                </div>
