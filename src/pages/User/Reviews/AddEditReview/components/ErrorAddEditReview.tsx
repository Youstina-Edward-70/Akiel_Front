...
interface ErrorAddEditReviewProps {
    message: string;
    onBack: () => void;
}

export const ErrorAddEditReview = ({ message, onBack }: ErrorAddEditReviewProps) => {
    return (
        <div className="min-h-[70dvh] bg-gray-50 flex items-center justify-center p-4 text-center">
            <div className="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full space-y-4">
                ...
                <h3 className="text-xl font-bold text-text-primary">Failed to load review page</h3>
