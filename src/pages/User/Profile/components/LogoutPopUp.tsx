...
export const LogoutPopUp = ({ isOpen, onClose, onConfirm, isLoading = false }: LogoutPopUpProps) => {
    return (
        <AnimatePresence>
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    >
                        <div className="flex flex-col items-center text-center gap-3">
                            ...
                            <h3 className="text-xl font-heading font-bold text-text-primary">Logout</h3>
